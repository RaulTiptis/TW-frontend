...
@Component({
  ...
  templateUrl: './studentregistered.component.html',
  styleUrls: ['./studentregistered.component.css']
})
export class StudentregisteredComponent implements OnInit {
